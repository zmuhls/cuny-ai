...
const RoadmapStep = () => {
  return (
    <div>
      ...
      <div className="mb-8">
        <h3 className="text-2xl font-semibold text-blue-800 mb-4">Roadmap</h3>
        ...
        <div className="space-y-6">
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-gray-600">A fun introduction to core terminology through an interactive fill-in-the-blank exercise. This helps you become familiar with important AI terms and concepts.</p>
            </div>
          </div>
