        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
            <div className="relative">
              <img src="images/recipe.jpg" alt="Pecan Butterballs Recipe Card" className="w-full h-40 object-cover" />
            ...
            <div className="p-4">
              ...
              <a href="pages/recipe.html" target="_blank" className="inline-flex items-center text-sm text-blue-600 hover:text-blue-800">
                View Comparison
          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
            <div className="relative">
              <img src="images/magician.jpg" alt="The Magician Engraving" className="w-full h-40 object-cover" />
            ...
            <div className="p-4">
              ...
              <a href="pages/magician.html" target="_blank" className="inline-flex items-center text-sm text-blue-600 hover:text-blue-800">
                View Comparison
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                </svg>
